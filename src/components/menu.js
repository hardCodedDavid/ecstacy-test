...
export const menuItems = [
  ...
  // },
  {
    ...
    label: 'Finances',
    isTitle: true,
    show: isPermitted('View Transactions'),
  },
  {
    id: 9,
    label: 'Transactions',
  ...
  },
  {
    id: 10,
    label: 'Payments',
    show: isPermitted('View Payments'),
  ...
  },
  {
    id: 11,
    label: 'Withdrawals',
    show: isPermitted('View Withdrawals'),
  ...
  },
  {
    id: 17,
    label: 'Notification',
    show: isPermitted('Create Notification'),
    icon: 'uil-comment-alt-notes',
