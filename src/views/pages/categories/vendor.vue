<script>
    ...
    export default {
      ...
      methods: {
        fetchCategory(){
            this.toggleBusy();
            this.axios.get('https://api.codedevents.com/admin/categories/vendor?page=1&per_page=10000')
            .then((res) => {
        ...
        addCategory(){
            if(this.categoryName == null){
                ...
                this.toggleBusy();
                this.axios.post('https://api.codedevents.com/admin/categories/vendor?name=' + this.categoryName)
                .then((res) => {
                    console.log(res.data.data);
                    this.fetchCategory();
        ...
        editCategory(){
            if(this.categoryName == ''){
                ...
                this.toggleBusy();
                this.axios.put('https://api.codedevents.com/admin/categories/vendor/' + this.categoryInfo.id + '?name=' + this.categoryName)
                .then((res) => {
                    console.log(res.data.data);
                    this.fetchCategory();
                    this.categoryName = null;
        ...
        deleteCategory(){
            if(this.categoryName == ''){
                ...
                this.toggleBusy();
                this.axios.delete('https://api.codedevents.com/admin/categories/vendor/' + this.categoryInfo.id + '?name=' + this.categoryName)
                .then((res) => {
                    console.log(res.data.data);
                    this.fetchCategory();
                    this.categoryName = null;
