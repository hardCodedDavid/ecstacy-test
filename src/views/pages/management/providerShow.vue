...
export default {
  ...
  methods: {
    ...
    editProduct() {
      ...
      this.axios
        .post(
          BASE_URL + '/admin/provider-service/' + this.product.id,
          formData, {
          headers: {
    ...
    toggleServiceStatus(item){
      ...
      this.axios
        .put(BASE_URL + '/admin/provider-service/' + item.id +'/'+status)
        .then(() => {
          // console.log(res.data.data);
          this.fetchData()
          this.$refs.mytoast.Add({
    ...
    enableService(id) {
      this.isBusy = true
      this.axios
        .put(BASE_URL + '/admin/provider-service/' + id + '/enable')
        .then(() => {
          // console.log(res.data.data);
          this.fetchData()
          this.$refs.mytoast.Add({
    ...
    disableService(id) {
      this.isBusy = true
      this.axios
        .put(BASE_URL + '/admin/provider-service/' + id + '/disable')
        .then(() => {
          // console.log(res.data.data);
          this.fetchData()
          this.$refs.mytoast.Add({
